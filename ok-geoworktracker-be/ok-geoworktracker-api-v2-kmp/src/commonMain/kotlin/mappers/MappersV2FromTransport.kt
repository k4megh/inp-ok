...
private fun TicketReadObject?.toInternal() = if (this != null) {
    GwtrTicket(id = id.toTicketId())
} else {
    GwtrTicket()
}
private fun String?.toSiteId() = this?.let { GwtrSiteId(it) } ?: GwtrSiteId.NONE
